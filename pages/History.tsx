  ...
  if (history.length === 0) {
    return (
      <div className="min-h-screen bg-neutral-950 flex flex-col items-center justify-center gap-4 text-neutral-400">
        ...
        <p className="text-lg font-medium">Chưa có lịch sử đọc truyện</p>
        <Link
          to="/"
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {history.map((item) => (
            <div
              key={item.comicId}
              className="bg-neutral-900 border border-neutral-800 hover:border-rose-600/50 transition-all group flex overflow-hidden rounded-lg"
            >
              <Link
