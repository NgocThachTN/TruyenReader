...
const CategoryDetail: React.FC = () => {
  ...
  useEffect(() => {
    window.scrollTo(0, 0); // Reset scroll to top when slug or page changes
    ...
    <div className="min-h-screen bg-neutral-950 font-sans pb-12">
      <div className="container mx-auto px-4 py-8">
        <motion.div
          ...
          className="mb-8 flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-neutral-800 pb-6"
        >
          <div>
        ...
        {totalPages > 1 && (
          ...
          >
            ...
            <div className="flex items-center gap-2">
              ...
              <button className="w-10 h-10 flex items-center justify-center bg-rose-600 text-white font-bold text-xs shadow-[0_0_15px_rgba(225,29,72,0.4)]">
                {currentPage}
              </button>
