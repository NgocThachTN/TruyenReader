  ...
  return (
    <div className="min-h-screen flex bg-neutral-950 font-sans">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-neutral-900 items-center justify-center overflow-hidden border-r border-neutral-900">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,_var(--tw-gradient-stops))] from-rose-900/40 via-neutral-950 to-neutral-950 z-10"></div>
        ...
        <div className="relative z-20 text-center px-12 max-w-xl">
          <div className="mb-8 inline-block p-4 bg-rose-600 rounded-none shadow-[0_0_30px_rgba(225,29,72,0.4)]">
          ...
          <h2 className="text-3xl font-bold text-white mb-6 leading-tight">
            ...
            <span className="text-rose-500">bất tận</span>
          </h2>
          <p className="text-neutral-400 text-lg leading-relaxed">
            Tham gia cộng đồng hàng nghìn độc giả. Cập nhật chap mới nhanh nhất,
            bình luận và lưu trữ truyện yêu thích của bạn.
          </p>
        </div>
      </div>
